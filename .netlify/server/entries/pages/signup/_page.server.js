...
const registrationSchema = z.object({
  name: z.string({ required_error: "Your name is required" }).min(1, { message: "Your name is required" }).max(64, { message: "Email must be less than 64 characters" }),
  ...
  confirmpassword: z.string({ required_error: "Confirmation Passord is required" }).min(8, { message: "Confirmation Password must be at least 8 characters" }).max(32, { message: "Confirmation Password must be less than 32 characters" }).trim()
