...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  authed = data.props.user;
  return `${$$result.head += `<!-- HEAD_svelte-vygk8c_START --><link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;600&display=swap" rel="stylesheet"><link rel="stylesheet" href="/global.css"><link rel="stylesheet" href="/splide-override.css"><!-- HEAD_svelte-vygk8c_END -->`, ""} <div id="preloader" data-svelte-h="svelte-16ua5r8"><div class="loader"></div></div> <nav class="menu-container"> <a href="/" class="menu-logo" data-svelte-h="svelte-1f83mvh"><img src="/favicon.png" alt="Website Logo"></a>  <div class="menu"><ul data-svelte-h="svelte-1gotkpo"><li><a href="/">Home</a></li> <li><a href="/movies" data-sveltekit-preload-data>Movies</a></li> <li><a href="/about">About</a></li></ul> <ul>${!authed || authed === null || authed === void 0 ? `<li data-svelte-h="svelte-1p56cxr"><a href="/signup">Sign-up</a></li> <li data-svelte-h="svelte-16gw1ns"><a href="/login">Login</a></li>` : `<form method="POST" action="/logout" data-svelte-h="svelte-2qb70f"><button class="nav-button">log out</button></form>`}</ul></div></nav> <div class="page-container"><div class="wrap svelte-auvwo8">${validate_component(SvelteToast, "SvelteToast").$$render(
    $$result,
    {
      target: "new",
      options: {
    ...
    {},
    {}
  )}</div> <div class="content-wrap">${slots.default ? slots.default({}) : ``}</div> <hr> <footer><div class="footer-content"><h3 data-svelte-h="svelte-3avibi">Groovy</h3> <p data-svelte-h="svelte-1qhaqsn">The groovy API frontend.</p> <ul class="socials" data-svelte-h="svelte-12ang4n"><li><a href="https://facebook.com"><img src="/facebook.png" alt="Facebook" width="24px" height="24px"></a></li> <li><a href="https://twitter.com"><img src="/twitter.png" alt="Twitter" width="24px" height="24px"></a></li> <li><a href="https://linkedin.com"><img src="/linkedin.png" alt="LinkedIn" width="24px" height="24px"></a></li></ul> <p>© ${escape((/* @__PURE__ */ new Date()).getFullYear())} Groovy. All rights reserved.</p> <p data-svelte-h="svelte-fqek3t">Powered by <a href="https://svelte.dev/">Svelte</a>,
				<a href="https://picocss.com/">Pico Css</a>
				and <a href="https://go.dev/">Golang.</a>.</p></div></footer> </div>`;
});
export {
  Layout as default
};
